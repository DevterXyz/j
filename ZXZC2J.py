...
prot = (random.randint(32500,4150))
...
\033[93m            ║ XXXXXXXXX  ║║ TCPDOWN ║║ HTTPS-STM  ║║ XXXXXX     ║
...
\033[35m                ╔═══════════════════════════════════════════════╗
\033[35m                ║\033[32m- - - - - - - ZXZ C2 By \033[36mSenzu \033[35m- - - - - - -║
\033[35m                ║\033[32m  - - - Type \033[36mmethods\033[35m to Help Menu - - - - ║
\033[35m                ╚═══════════════════════════════════════════════╝
"""
...
def main():
    ...
    while True:
        powerran = (random.randint(32500,4150))
